    ...
    extends JFrame
{
    ...
    private ArrayList<Term>     matches;                // = new
                                                        // ArrayList<Trie>();
...
// }
        ...
        public void getSuggestions(String text)
        {
            ...
            else
            {
                ...
                //auto.listTries.clear();
                // get all matching terms
                //auto.printTrie(auto.getSubTrie(text), text);
                matches = auto.getSuggestions(text);
                //auto.getSuggestions(auto.getSubTrie(text), text, matches);

                 Collections
                 .sort(matches, Term.byReverseWeightOrder());
                 //Collections
                 //.sort(matches, Term.byPrefixOrder(textLen));
